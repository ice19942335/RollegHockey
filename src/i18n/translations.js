export const translations = {
  ru: {
    ...
    deleteAllPendingGamesTitle: 'Удалить все игры?',
    deleteAllPendingGamesMessage: 'Вы уверены, что хотите удалить все {count} игр в процессе? Это действие нельзя отменить.',
  ...
  lv: {
    ...
    deleteAllPendingGamesTitle: 'Dzēst visas spēles?',
    deleteAllPendingGamesMessage: 'Vai tiešām vēlaties dzēst visas {count} spēles procesā? Šo darbību nevar atsaukt.',
